...
class CyfoxApp:
    ...
    def _render_text(self, text: str, position: tuple, color=(255, 255, 255), 
        ...
        if not text:
            return
        text_surface = self.text_renderer.render_text(text, size=size, color=color, max_width=max_width)
    ...
    def _render_ui(self):
        ...
        if self.state_manager.state == CyfoxState.ALERT:
            ...
            if post:
                ...
                title_surf = self.text_renderer.render_text(title, size=8, max_width=self.display.width - 4)
            ...
            if self.state_manager.state == CyfoxState.SCANNING:
                ...
                if results:
                    ...
                    result_surf = self.text_renderer.render_text(result_text, size=8, color=(0, 255, 0))
